...
from server.domain.schemas import InputTaskGeneration, TaskStatus, TaskType
from server.domain.schemas.main import TaskGeneration, TaskAvatarGeneration, TaskVideoPreviewGeneration, \
